...
def step_impl(context):
    User.objects.create(username='AAAAAAA', password='BBBBBB')
...
def step_impl(context):
    ...
    browser.find_element_by_id('id_username').send_keys('AAAAAAA')
    browser.find_element_by_id('id_password').send_keys('BBBBBB')
